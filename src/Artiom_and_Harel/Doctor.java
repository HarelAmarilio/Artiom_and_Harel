...
public class Doctor extends Lecturer implements Comparable<Doctor>{
    ...
    public Doctor(String fullName, int ID, DgreeNames degreeType, String degreeName, double salary, String department,int numberOfArticle,String [] articles) {
    ...
    public String toString() {
        return super.toString()+
                ...
                ", articles name=" + Arrays.toString(articles);
    }
}
